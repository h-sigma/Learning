Shader "Learning/Plasma"
{
    Properties
    {
        _Tint ("Tint", Color) = (1, 1, 1, 1)
        _Speed ("Speed", Range(1, 100)) = 1.0
        _Scale1 ("Scale 1", Range(0.2, 10)) = 4.0
        _Scale2 ("Scale 2", Range(0.2, 10)) = 4.0
        _Scale3 ("Scale 3", Range(0.2, 10)) = 4.0
        _Scale4 ("Scale 4", Range(0.2, 10)) = 4.0
    }
    SubShader
    {
        Tags {"Queue" = "Geometry"}
