...
[CreateAssetMenu(fileName =  "Shake Transform Event", menuName =  "VFX/Shake Transform Event", order = 1)]
public class ShakeTransformEventData : ScriptableObject
{
    ...
    public void Init(float amplitude, float frequency, float duration, AnimationCurve curve, Target target)
    {
        this.target = target;
